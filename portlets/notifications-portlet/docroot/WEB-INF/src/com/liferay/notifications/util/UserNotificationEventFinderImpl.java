 ...
 * @author Lin Cui
 */
public class UserNotificationEventFinderImpl
	implements UserNotificationEventFinder {
	...
	public List<UserNotificationEvent>
		...
		DynamicQuery dynamicQuery = getDynamicQuery(
				userId, actionable, actionableTypes, archived);
	...
	protected DynamicQuery getDynamicQuery(
		...
		if (actionable) {
			...
			disjuncton.add(RestrictionsFactoryUtil.in("type", actionableTypes));
			...
			for (String actionableType : actionableTypes) {
				conjunction.add(
