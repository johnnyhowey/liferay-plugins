...
<c:choose>
	<c:when test="<%= group.isUser() %>">
		...
		Layout contactsLayout = LayoutLocalServiceUtil.getFriendlyURLLayout(group.getGroupId(), false, "/contacts");
				...
				<aui:layout cssClass="my-contacts">
					...
					%>
						...
						<c:if test="<%= portletURL != null %>">
							<a href="<%= portletURL %>"><liferay-ui:message arguments="<%= group.getDescriptiveName() %>"key="view-all-x-contacts" /></a>
						</c:if>
