...
package com.liferay.trending.service.persistence.impl;
...
import com.liferay.trending.NoSuchAssetTrendingEntryException;
import com.liferay.trending.model.AssetTrendingEntry;
import com.liferay.trending.model.impl.AssetTrendingEntryImpl;
import com.liferay.trending.model.impl.AssetTrendingEntryModelImpl;
import com.liferay.trending.service.persistence.AssetTrendingEntryPersistence;
...
public class AssetTrendingEntryPersistenceImpl extends BasePersistenceImpl<AssetTrendingEntry>
	...
	public AssetTrendingEntry findByAssetEntryId(long assetEntryId)
		throws NoSuchAssetTrendingEntryException {
		...
		if (assetTrendingEntry == null) {
			...
			throw new NoSuchAssetTrendingEntryException(msg.toString());
		}
	...
	public AssetTrendingEntry remove(Serializable primaryKey)
		...
		try {
			...
			if (assetTrendingEntry == null) {
				...
				throw new NoSuchAssetTrendingEntryException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(assetTrendingEntry);
		}
		catch (NoSuchAssetTrendingEntryException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
