...
public class AssetSharingEntryLocalServiceClpInvoker {
	public AssetSharingEntryLocalServiceClpInvoker() {
		...
		_methodName54 = "getAssetSharingEntriesBySharedTo";

		_methodParameterTypes54 = new String[] { "long", "long", "int", "int" };

		_methodName55 = "getAssetSharingEntriesBySharedTo";

		_methodParameterTypes55 = new String[] {
				"long", "long", "long", "int", "int"
			};

		_methodName56 = "getAssetSharingEntriesBySharedToCount";

		_methodParameterTypes56 = new String[] { "long", "long" };

		_methodName57 = "getAssetSharingEntriesBySharedToCount";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName54.equals(name) &&
			...
			return AssetSharingEntryLocalServiceUtil.getAssetSharingEntriesBySharedTo(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(),
				((Integer)arguments[2]).intValue(),
		...
		if (_methodName56.equals(name) &&
			...
			return AssetSharingEntryLocalServiceUtil.getAssetSharingEntriesBySharedToCount(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}
