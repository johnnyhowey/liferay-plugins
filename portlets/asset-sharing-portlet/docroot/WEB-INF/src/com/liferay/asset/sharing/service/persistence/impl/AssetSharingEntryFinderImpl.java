...
public class AssetSharingEntryFinderImpl
	...
	public int countAssetEntriesByUserId(
		...
		try {
			...
			sql = StringUtil.replace(
				...
				getClassNameIdsSharedToClassNameIdsClassPKs(
			...
			setClassNameIdsSharedToClassNameIdsClassPKs(
				qPos, userId, classNameIds, sharedToClassNameIdsClassPKs);
	...
	public List<Object[]> findAssetEntriesByUserId(
		long userId, long[] classNameIds,
		Map<Long, long[]> sharedToClassNameIdsClassPKs, int start, int end) {
	...
	protected String getClassNameIdsSharedToClassNameIdsClassPKs(
		long[] classNameIds, Map<Long, long[]> sharedToClassNameIdsClassPKs) {
		...
		sb.append(
			getSharedToClassNameIdsClassPKs(sharedToClassNameIdsClassPKs));

		return sb.toString();
	}

	protected String getSharedToClassNameIdClassPKs(
	...
	protected String getSharedToClassNameIdsClassPKs(
		Map<Long, long[]> sharedToClassNameIdsClassPKs) {
		...
		if (sharedToClassNameIdsClassPKs != null) {
			for (Map.Entry<Long, long[]> entry :
					sharedToClassNameIdsClassPKs.entrySet()) {
				...
				if (sharedToClassNameId == _SOCIAL_RELATION_CLASS_NAME_ID) {
					...
					sb.append(
						getSharedToClassNameIdClassPKs(
	...
	protected void setClassNameIdsSharedToClassNameIdsClassPKs(
		...
		if (sharedToClassNameIdsClassPKs != null) {
			for (Long sharedToClassNameId :
					sharedToClassNameIdsClassPKs.keySet()) {
