...
public class AssetSharingEntryLocalServiceImpl
	...
	public void addAssetSharingEntries(
		...
		for (Long sharedToClassNameId : scopes.keySet()) {
			long[] sharedToClassPKs = scopes.get(sharedToClassNameId);
	...
	@Override
	public List<AssetSharingEntry> getAssetSharingEntriesBySharedTo(
	...
	@Override
	public int getAssetSharingEntriesBySharedToCount(
