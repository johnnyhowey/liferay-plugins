...
public class AssetSharingEntryLocalServiceWrapper
	...
	*/
	...
	public int countAssetSharingEntriesByScope(long classNameId,
		long sharedToClassNameId, long sharedToClassPK) {
		return _assetSharingEntryLocalService.countAssetSharingEntriesByScope(classNameId,
	...
	public int countAssetSharingEntriesByScope(long sharedToClassNameId,
		...
		return _assetSharingEntryLocalService.countAssetSharingEntriesByScope(sharedToClassNameId,
			sharedToClassPK);
	}
	...
	*/
	...
	public java.util.List<com.liferay.asset.sharing.model.AssetSharingEntry> getAssetSharingEntriesByScope(
		...
		int start, int end) {
		return _assetSharingEntryLocalService.getAssetSharingEntriesByScope(classNameId,
	...
	public java.util.List<com.liferay.asset.sharing.model.AssetSharingEntry> getAssetSharingEntriesByScope(
		...
		return _assetSharingEntryLocalService.getAssetSharingEntriesByScope(sharedToClassNameId,
