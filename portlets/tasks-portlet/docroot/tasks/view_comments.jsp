...
<form action="<portlet:actionURL name="updateMessage"><portlet:param name="jspPage" value="/tasks/view_task.jsp" /></portlet:actionURL>" method="post" name="<portlet:namespace />fm2">
